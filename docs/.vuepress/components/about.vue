  ...
  <div class="about">
    <ul class="aboutNav">
      <li
        ...
        :style="
          cur === item.code ? 'background:rgba(0,0,0,0.25);color:#fff;' : ''
        "
        class="aboutNavItem"
      >
        {{ item.title }}
        ...
        <ul>
          <li>
            <img src="../public/star.png" /><span
              >2015.09 ~ 2019.06: zzu-undergraduate</span
            >
          </li>
          <li>
            <img src="../public/star.png" /><span
              >2019.06 ~ 2020.07: yioks-前端工程师</span
            >
          </li>
          <li>
            <img src="../public/star.png" /><span
              >2021.09 ~ now: zzu-postgraduate</span
            >
          </li>
        </ul>
      </div>
